...
_None — APIDRIFT-4 just landed, uncommitted._

## Ready

- [APIDRIFT-5](./tickets/APIDRIFT-5-action-enum-serde.md) — action enum + attrs + serde + snapshot v1 | M2 |

## Backlog

| ID | Task | Notes |
|----|------|-------|
| [APIDRIFT-6](./tickets/APIDRIFT-6-surface-ledger.md) | Surface trait + ledger crate, dogfood | after 5 |
