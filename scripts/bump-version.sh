#!/usr/bin/env bash
# scripts/bump-version.sh — bump the api-drift version on merge to main.
...
GIT_USER="${BUMPVER_GIT_USER:-api-drift-release}"
GIT_EMAIL="${BUMPVER_GIT_EMAIL:-release@api-drift.local}"
